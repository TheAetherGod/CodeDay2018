			...
			<div id = "intrested?Sponsor?Going?" style = "width: 100%; height: 40%; padding:0px;margin:0px;">
				...
				<tr style = "height: 15%; font-size: 40px;">
					...
					<tr style = "height: 70%;font-size: 32px;">
						<th style = "text-align: center;text-shadow: 2px 2px 4px #000;color:rgb(100, 248, 144);">Interested?</th>
						<th style = "text-align: center;text-shadow: 2px 2px 4px #000;color:rgb(100, 248, 144);">Sponsor!</th>
					</tr>
